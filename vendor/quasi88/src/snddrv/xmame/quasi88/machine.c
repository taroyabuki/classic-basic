...
static	T_XMAME_FUNC pc88_sound_func =
{
	...
	PCG8100_gate_port_0_w,
	PCG8100_counter0_port_0_w,
	PCG8100_counter1_port_0_w,
	PCG8100_counter2_port_0_w,
	PCG8100_control_port_0_w,
	SAMPLE_motoron,
	SAMPLE_motoroff,
	SAMPLE_headdown,
	SAMPLE_headup,
...
static MACHINE_DRIVER_START( quasi88 )
	...
	MDRV_SOUND_ADD(PCG8100, 3993600)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "left",  1.0)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "right", 1.0)
    /* 0 = PCG */
