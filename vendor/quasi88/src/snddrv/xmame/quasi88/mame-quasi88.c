...
int pcgvol			=  60;		/* level of PCG   (0-100)[%] */
...
typedef struct {				/* list of mame-sound-I/F functions */
	...
	void	(*pcg_out_gate)    (ATTR_UNUSED offs_t offset, ATTR_UNUSED UINT8 data);
	void	(*pcg_out_counter0)(ATTR_UNUSED offs_t offset, ATTR_UNUSED UINT8 data);
	void	(*pcg_out_counter1)(ATTR_UNUSED offs_t offset, ATTR_UNUSED UINT8 data);
	void	(*pcg_out_counter2)(ATTR_UNUSED offs_t offset, ATTR_UNUSED UINT8 data);
	void	(*pcg_out_control) (ATTR_UNUSED offs_t offset, ATTR_UNUSED UINT8 data);
...
int		xmame_sound_start(void)
{
	...
	if (sound_init(NULL) == 0) {
		...
		PCG8100_set_volume(pcgvol/100.0F);
...
void	xmame_dev_pcg_out_gate(byte data)
{
	if (xmame_func->pcg_out_gate) (xmame_func->pcg_out_gate)(0,data);
}
void	xmame_dev_pcg_out_counter0(byte data)
{
	if (xmame_func->pcg_out_counter0) (xmame_func->pcg_out_counter0)(0,data);
}
void	xmame_dev_pcg_out_counter1(byte data)
{
	if (xmame_func->pcg_out_counter1) (xmame_func->pcg_out_counter1)(0,data);
}
void	xmame_dev_pcg_out_counter2(byte data)
{
	if (xmame_func->pcg_out_counter2) (xmame_func->pcg_out_counter2)(0,data);
}
void	xmame_dev_pcg_out_control(byte data)
{
	if (xmame_func->pcg_out_control) (xmame_func->pcg_out_control)(0,data);
}
...
void	xmame_cfg_set_mixer_volume(int ch, int level)
{
	if (use_sound) {
		...
		case XMAME_MIXER_PCG:
			if (level < PCGVOL_MIN) level = PCGVOL_MIN;
			if (level > PCGVOL_MAX) level = PCGVOL_MAX;
			PCG8100_set_volume(level/100.0F);
			pcgvol = level;
			break;
...
int		xmame_cfg_get_mixer_volume(int ch)
{
	...
	case XMAME_MIXER_PCG:		return pcgvol;
