...
/*{ 354, "v",            X_INT,  &attenuation,     -32, 0,                  0, 0        },*/
  ...
  { 358, "pcgvol",       X_INT,  &pcgvol,          0, 100,                  0, OPT_SAVE },
  { 358, "gv",           X_INT,  &pcgvol,          0, 100,                  0, 0        },
  { 359, "rhythmvol",    X_INT,  &rhythmvol,       0, 200,                  0, OPT_SAVE },
  { 359, "rv",           X_INT,  &rhythmvol,       0, 200,                  0, 0        },
  { 360, "adpcmvol",     X_INT,  &adpcmvol,        0, 200,                  0, OPT_SAVE },
  { 360, "av",           X_INT,  &adpcmvol,        0, 200,                  0, 0        },
  { 361, "fmgenvol",     X_INT,  &fmgenvol,        0, 100,                  0, OPT_SAVE },
  { 361, "fmv",          X_INT,  &fmgenvol,        0, 100,                  0, 0        },
  { 362, "samplevol",    X_INT,  &samplevol,       0, 100,                  0, OPT_SAVE },
  { 362, "sv",           X_INT,  &samplevol,       0, 100,                  0, 0        },

  { 363, "samplefreq",   X_INT,  &options.samplerate, 8000, 48000,          0, OPT_SAVE },
  { 363, "sf",           X_INT,  &options.samplerate, 8000, 48000,          0, 0        },

  { 364, "samples",      X_FIX,  &options.use_samples, 1,                 0,0, OPT_SAVE },
  { 364, "sam",          X_FIX,  &options.use_samples, 1,                 0,0, 0        },
  { 364, "nosamples",    X_FIX,  &options.use_samples, 0,                 0,0, OPT_SAVE },
  { 364, "nosam",        X_FIX,  &options.use_samples, 0,                 0,0, 0        },

  { 365, "sdlbufsize",   X_INT,  &sdl_buffersize,  32, 65536,               0, OPT_SAVE },
  { 366, "sdlbufnum",    X_INV,  &invalid_arg,                          0,0,0, 0        },
  { 367, "close",        X_FIX,  &close_device,    TRUE,                  0,0, OPT_SAVE },
  { 367, "noclose",      X_FIX,  &close_device,    FALSE,                 0,0, OPT_SAVE },
 ...
 *      標準出力にヘルプメッセージを表示する。
 *****************************************************************************/
void	xmame_config_show_option(FILE *fp)
{
  fprintf(fp,
  "\n"
  "==========================================\n"
...
/*"    -volume / -v <i>        Set volume to <int> db, (-32(soft) - 0(loud))\n"*/
  ...
  "    -pcgvol / -gv <i>       Set PCG    level to <i> %%, (0 - 100) [60]\n"
