...
#define xmame_config_show_option(fp)
...
#define xmame_dev_pcg_out_gate(d)
#define xmame_dev_pcg_out_counter0(d)
#define xmame_dev_pcg_out_counter1(d)
#define xmame_dev_pcg_out_counter2(d)
#define xmame_dev_pcg_out_control(d)
