...
static const int mac2keycode[128][2] = {
	...
	{ 0,					0,					},	/* 0x66 eusii		*/
	{ KEY88_SYS_STATUS,		KEY88_SYS_STATUS,	},	/* 0x67				*/
	...
	{ 0,					0,					},	/*					*/
	{ KEY88_SYS_MENU,		KEY88_SYS_MENU,		},	/* 0x6F				*/
	{ 0,					0,					},	/*					*/
...
void event_update(void)
{
	...
	// event loop
	while (loop) {
		if (WaitNextEvent(everyEvent, &event, 0, NULL) == false) {
			break;
		}
		...
		case autoKey:			/* ------------------------------------------*/
			...
			if (event.modifiers & cmdKey) {
				...
				case 0x12:			/* Cmd + 1 */
					kon[0] = 1;
					quasi88_key_pressed(KEY88_F1);
					break;
				case 0x13:			/* Cmd + 2 */
					kon[1] = 1;
					quasi88_key_pressed(KEY88_F2);
					break;
				case 0x14:			/* Cmd + 3 */
					kon[2] = 1;
					quasi88_key_pressed(KEY88_F3);
					break;
				case 0x15:			/* Cmd + 4 */
					kon[3] = 1;
					quasi88_key_pressed(KEY88_F4);
					break;
				case 0x17:			/* Cmd + 5 */
					kon[4] = 1;
					quasi88_key_pressed(KEY88_F5);
					break;
				case 0x08:			/* Cmd + C */
					kon[5] = 1;
					quasi88_key_pressed(KEY88_COPY);
					break;
				case 0x01:			/* Cmd + S */
					kon[6] = 1;
					quasi88_key_pressed(KEY88_STOP);
					break;
				case 0x04:			/* Cmd + H */
					kon[7] = 1;
					quasi88_key_pressed(KEY88_HELP);
					break;
				case 0x7e:			/* Cmd +↑ */
				case 0x3e:
					kon[8] = 1;
					quasi88_key_pressed(KEY88_ROLLUP);
					break;
				case 0x7d:			/* Cmd +↓ */
				case 0x3d:
					kon[9] = 1;
					quasi88_key_pressed(KEY88_ROLLDOWN);
					break;
				case 0x2e:			/* Cmd + M */
					kon[10] = 1;
					quasi88_key_pressed(KEY88_SYS_MENU);
					break;
				}
			}
			break;
		...
		case keyUp:				/* ------------------------------------------*/
			{
				...
				case 0x12:			/* Cmd + 1 */
					if (kon[0]) {
						kon[0] = 0;
						quasi88_key_released(KEY88_F1);
					}
					break;
				case 0x13:			/* Cmd + 2 */
					if (kon[1]) {
						kon[1] = 0;
						quasi88_key_released(KEY88_F2);
					}
					break;
				case 0x14:			/* Cmd + 3 */
					if (kon[2]) {
						kon[2] = 0;
						quasi88_key_released(KEY88_F3);
					}
					break;
				case 0x15:			/* Cmd + 4 */
					if (kon[3]) {
						kon[3] = 0;
						quasi88_key_released(KEY88_F4);
					}
					break;
				case 0x17:			/* Cmd + 5 */
					if (kon[4]) {
						kon[4] = 0;
						quasi88_key_released(KEY88_F5);
					}
					break;
				case 0x08:			/* Cmd + C */
					if (kon[5]) {
						kon[5] = 0;
						quasi88_key_released(KEY88_COPY);
					}
					break;
				case 0x01:			/* Cmd + S */
					if (kon[6]) {
						kon[6] = 0;
						quasi88_key_released(KEY88_STOP);
					}
					break;
				case 0x04:			/* Cmd + H */
					if (kon[7]) {
						kon[7] = 0;
						quasi88_key_released(KEY88_HELP);
					}
					break;
				case 0x7e:			/* Cmd +↑ */
				case 0x3e:
					if (kon[8]) {
						kon[8] = 0;
						quasi88_key_released(KEY88_ROLLUP);
					}
					break;
				case 0x7d:			/* Cmd +↓ */
				case 0x3d:
					if (kon[9]) {
						kon[9] = 0;
						quasi88_key_released(KEY88_ROLLDOWN);
					}
					break;
				case 0x2e:			/* Cmd + M */
					if (kon[10]) {
						kon[10] = 0;
						quasi88_key_released(KEY88_SYS_MENU);
					}
					break;
				}
			}
