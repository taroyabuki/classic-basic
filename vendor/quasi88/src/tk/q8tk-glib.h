...
extern int q8gr_is_solid;
#define q8gr_set_solid(s)	q8gr_is_solid = (s)
#define q8gr_get_solid(s)	(q8gr_is_solid)
...
void	q8gr_draw_hscale(int x, int y, Q8Adjust *adj, int active,
						 int draw_value, int value_pos, int adj_size, void *p);
