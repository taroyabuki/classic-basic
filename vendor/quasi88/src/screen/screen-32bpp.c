...
#define			MENU2SCREEN						tool2screen_F_N_32
#include										"screen-menu-full.h"
...
#define			MENU2SCREEN						stat2screen_F_N_32
#include										"screen-menu-full.h"
...
#define			MENU_START		screen_tool_start
#define			MENU_DECORATE	1
#define			MENU2SCREEN						tool2screen_H_N_32
#include										"screen-menu-half.h"
...
#define			MENU_START		screen_stat_start
#define			MENU_DECORATE	2
#define			MENU2SCREEN						stat2screen_H_N_32
#include										"screen-menu-half.h"
...
#define			MENU_START		screen_tool_start
#define			MENU_DECORATE	1
#define			MENU2SCREEN						tool2screen_H_P_32
#include										"screen-menu-half-p.h"
...
#define			MENU_START		screen_stat_start
#define			MENU_DECORATE	2
#define			MENU2SCREEN						stat2screen_H_P_32
#include										"screen-menu-half-p.h"
...
#define			MENU_START		screen_tool_start
#define			MENU_DECORATE	1
#define			MENU2SCREEN						tool2screen_D_N_32
#include										"screen-menu-double.h"
...
#define			MENU_START		screen_stat_start
#define			MENU_DECORATE	2
#define			MENU2SCREEN						stat2screen_D_N_32
#include										"screen-menu-double.h"
#endif
...
int (*vram2screen_list_F_N_32[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_F_S_32[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_F_I_32[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_H_N_32[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_H_P_32[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_D_N_32[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_D_S_32[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_D_I_32[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_F_N_32_d[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_D_N_32_d[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_D_S_32_d[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_D_I_32_d[4][4][2])(T_RECTANGLE *updated_area) = {
	{
