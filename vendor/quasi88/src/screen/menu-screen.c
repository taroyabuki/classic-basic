...
/*                                                                      */
/* voie menu_draw( void )                                               */
/*      ・メニュー画面の表示。ワーク T_Q8GR_TVRAM q8gr_tvram[][] に     */
...
/*======================================================================*/
/*                                                                      */
/*      メニュー画面のワーク q8gr_tvram[30][80] の構造体である。        */
/*      メニュー画面は、80文字×30行で構成されており、その1文字毎に、   */
/*      T_Q8GR_TVRAM 型のワークが1個、割り当てられている。              */
/*                                                                      */
