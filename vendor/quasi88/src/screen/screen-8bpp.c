...
#define			MENU2SCREEN						tool2screen_F_N__8
#include										"screen-menu-full.h"
...
#define			MENU2SCREEN						stat2screen_F_N__8
#include										"screen-menu-full.h"
...
#define			MENU_START		screen_tool_start
#define			MENU_DECORATE	1
#define			MENU2SCREEN						tool2screen_H_N__8
#include										"screen-menu-half.h"
...
#define			MENU_START		screen_stat_start
#define			MENU_DECORATE	2
#define			MENU2SCREEN						stat2screen_H_N__8
#include										"screen-menu-half.h"
...
#define			MENU_START		screen_tool_start
#define			MENU_DECORATE	1
#define			MENU2SCREEN						tool2screen_H_P__8
#include										"screen-menu-half-p.h"
...
#define			MENU_START		screen_stat_start
#define			MENU_DECORATE	2
#define			MENU2SCREEN						stat2screen_H_P__8
#include										"screen-menu-half-p.h"
...
#define			MENU_START		screen_tool_start
#define			MENU_DECORATE	1
#define			MENU2SCREEN						tool2screen_D_N__8
#include										"screen-menu-double.h"
...
#define			MENU_START		screen_stat_start
#define			MENU_DECORATE	2
#define			MENU2SCREEN						stat2screen_D_N__8
#include										"screen-menu-double.h"
#endif
...
int (*vram2screen_list_F_N__8[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_F_S__8[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_F_I__8[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_H_N__8[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_H_P__8[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_D_N__8[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_D_S__8[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_D_I__8[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_F_N__8_d[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_D_N__8_d[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_D_S__8_d[4][4][2])(T_RECTANGLE *updated_area) = {
	{
...
int (*vram2screen_list_D_I__8_d[4][4][2])(T_RECTANGLE *updated_area) = {
	{
