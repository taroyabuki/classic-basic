...
/* システム依存のヘルプ表示関数 */
static void (*help_msg_osd)(FILE *fp) = NULL;

/* システム依存のログ出力ファイル取得関数 */
static FILE *(*output_fp_osd)(void) = NULL;
...
/*----------------------------------------------------------------------*/
/* オプション解析中に結果を出力する、 STDERR, STDOUT を取得する。
 * システム依存の取得関数があれば、初めて出力する際にその関数を呼び出して、
 * 取得する。取得できなければ、 stderr, stdout を使う */
static FILE *osd_fp_stderr = NULL;
static FILE *osd_fp_stdout = NULL;
static void set_osd_fp(void)
{
	if (osd_fp_stderr == NULL) {
		if (output_fp_osd) {
			osd_fp_stdout = osd_fp_stderr = (output_fp_osd)();
		}
		if (osd_fp_stderr == NULL) {
			osd_fp_stderr = stderr;
			osd_fp_stdout = stdout;
		}
	}
}
static FILE *fp_stderr(void)
{
	set_osd_fp();
	return osd_fp_stderr;
}
static FILE *fp_stdout(void)
{
	set_osd_fp();
	return osd_fp_stdout;
}
...
{
	help_msg_common(fp_stdout());
	if (help_msg_osd) {
		(help_msg_osd)(fp_stdout());
	}
	help_msg_config(fp_stdout());
	xmame_config_show_option(fp_stdout());
	exit(0);
	return 0;
}

static int o_verbose(UNUSED_ARG)
{
...
static int o_4mhz(UNUSED_ARG)
{
	cpu_clock_mhz = CONST_4MHZ_CLOCK;
	return 0;
}
static int o_8mhz(UNUSED_ARG)
{
	cpu_clock_mhz = CONST_8MHZ_CLOCK;
	return 0;
}

static int o_width(UNUSED_ARG)
{
	WIDTH  &= ~7;
	return 0;
}
static int o_height(UNUSED_ARG)
{
	HEIGHT &= ~1;
	return 0;
}

static int o_set_version(UNUSED_ARG)
{
	set_version += '0';
	return 0;
}
...
static int o_setfn_6(char *str)
{
	return oo_setfn(6, str);
}
static int o_setfn_7(char *str)
{
	return oo_setfn(7, str);
}
static int o_setfn_8(char *str)
{
	return oo_setfn(8, str);
}
static int o_setfn_9(char *str)
{
	return oo_setfn(9, str);
}
static int o_setfn_10(char *str)
{
	return oo_setfn(10, str);
}
...
static int o_setkey_up(char *keysym)
{
	return oo_setinput(0, 0, keysym);
}
static int o_setkey_down(char *keysym)
{
	return oo_setinput(0, 1, keysym);
}
static int o_setkey_left(char *keysym)
{
	return oo_setinput(0, 2, keysym);
}
static int o_setkey_right(char *keysym)
{
	return oo_setinput(0, 3, keysym);
}

static int o_setmouse_up(char *ksym)
{
	return oo_setinput(1, 0, ksym);
}
static int o_setmouse_down(char *ksym)
{
	return oo_setinput(1, 1, ksym);
}
static int o_setmouse_left(char *ksym)
{
	return oo_setinput(1, 2, ksym);
}
static int o_setmouse_right(char *ksym)
{
	return oo_setinput(1, 3, ksym);
}
static int o_setmouse_l(char *ksym)
{
	return oo_setinput(1, 4, ksym);
}
static int o_setmouse_r(char *ksym)
{
	return oo_setinput(1, 5, ksym);
}

static int o_setjoy_up(char *keysym)
{
	return oo_setinput(2, 0, keysym);
}
static int o_setjoy_down(char *keysym)
{
	return oo_setinput(2, 1, keysym);
}
static int o_setjoy_left(char *keysym)
{
	return oo_setinput(2, 2, keysym);
}
static int o_setjoy_right(char *keysym)
{
	return oo_setinput(2, 3, keysym);
}
static int o_setjoy_a(char *keysym)
{
	return oo_setinput(2, 4, keysym);
}
static int o_setjoy_b(char *keysym)
{
	return oo_setinput(2, 5, keysym);
}
static int o_setjoy_c(char *keysym)
{
	return oo_setinput(2, 6, keysym);
}
static int o_setjoy_d(char *keysym)
{
	return oo_setinput(2, 7, keysym);
}
static int o_setjoy_e(char *keysym)
{
	return oo_setinput(2, 8, keysym);
}
static int o_setjoy_f(char *keysym)
{
	return oo_setinput(2, 9, keysym);
}
static int o_setjoy_g(char *keysym)
{
	return oo_setinput(2, 10, keysym);
}
static int o_setjoy_h(char *keysym)
{
	return oo_setinput(2, 11, keysym);
}

static int o_menu(UNUSED_ARG)
{
	quasi88_menu();
	return 0;
}
#ifdef USE_MONITOR
static int o_monitor(UNUSED_ARG)
{
	quasi88_monitor();
	return 0;
}
...
static int oo_resumefilename(char *filename, int force)
{
	if (filename && (strlen(filename) >= QUASI88_MAX_FILENAME)) {
		fprintf(fp_stderr(), "filename %s too long, ignored\n", filename);
		resume_flag  = FALSE;
		resume_force = FALSE;
		resume_file  = FALSE;
...
static int o_resume(UNUSED_ARG)
{
	return oo_resumefilename(NULL,  FALSE);
}
static int o_resumefile(char *fname)
{
	return oo_resumefilename(fname, FALSE);
}
static int o_resumeforce(char *fname)
{
	return oo_resumefilename(fname, TRUE);
}
...
static int oo_setdir(int type, char *dir)
{
	...
	case 0:
		opt = "romdir";
		result = osd_set_dir_rom(dir);
		break;
	case 1:
		opt = "diskdir";
		result = osd_set_dir_disk(dir);
		break;
	case 2:
		opt = "tapedir";
		result = osd_set_dir_tape(dir);
		break;
	case 3:
		opt = "snapdir";
		result = osd_set_dir_snap(dir);
		break;
	case 4:
		opt = "statedir";
		result = osd_set_dir_state(dir);
		break;
	}

	if (result == FALSE) {
		fprintf(fp_stderr(), "-%s %s failed, ignored\n", opt, dir);
	}
	return 0;
}
static int o_romdir(char *dir)
{
	return oo_setdir(0, dir);
}
static int o_diskdir(char *dir)
{
	return oo_setdir(1, dir);
}
static int o_tapedir(char *dir)
{
	return oo_setdir(2, dir);
}
static int o_snapdir(char *dir)
{
	return oo_setdir(3, dir);
}
static int o_statedir(char *dir)
{
	return oo_setdir(4, dir);
}
...
static int o_tapeload(UNUSED_ARG)
{
	return oo_image(&config_image.t[CLOAD]);
}
static int o_tapesave(UNUSED_ARG)
{
	return oo_image(&config_image.t[CSAVE]);
}
static int o_printer(UNUSED_ARG)
{
	return oo_image(&config_image.prn);
}
static int o_serialin(UNUSED_ARG)
{
	return oo_image(&config_image.sin);
}
static int o_serialout(UNUSED_ARG)
{
	return oo_image(&config_image.sout);
}
...
static const T_CONFIG_TABLE option_table[] = {
	...
	{   9, "mouse",			X_FIX,	&mouse_mode,		MOUSE_MOUSE,	0,				0,				OPT_SAVE	},
	{   9, "nomouse",		X_FIX,	&mouse_mode,		MOUSE_NONE,		0,				0,				OPT_SAVE	},
	{   9, "joymouse",		X_FIX,	&mouse_mode,		MOUSE_JOYMOUSE,	0,				0,				OPT_SAVE	},
	{   9, "joystick",		X_FIX,	&mouse_mode,		MOUSE_JOYSTICK,	0,				0,				OPT_SAVE	},
	...
	{  13, "pcg_level",		X_INT,	&pcg_level,			0,				1,				0,				OPT_SAVE	},
	{  14, "tapeload",		X_STR,	&config_image.t[CLOAD],		0,		0,				o_tapeload,		0			},
	{  15, "tapesave",		X_STR,	&config_image.t[CSAVE],		0,		0,				o_tapesave,		0			},
	{  16, "serialmouse",	X_FIX,	&use_siomouse,		TRUE,			0,				0,				OPT_SAVE	},
	{  16, "noserialmouse",	X_FIX,	&use_siomouse,		FALSE,			0,				0,				OPT_SAVE	},
	...
	{  72, "status",		X_FIX,	&show_statusbar,	TRUE,			0,				0,				OPT_SAVE	},
	{  72, "nostatus",		X_FIX,	&show_statusbar,	FALSE,			0,				0,				OPT_SAVE	},
	{  73, "status_fg",		X_INV,	&invalid_arg,		0,				0,				0,				0			},
	{  74, "status_bg",		X_INV,	&invalid_arg,		0,				0,				0,				0			},
	...
	{ 118, "f1",			X_INV,	&invalid_arg,		0,				0,				0,				0			},
	{ 119, "f2",			X_INV,	&invalid_arg,		0,				0,				0,				0			},
	{ 120, "f3",			X_INV,	&invalid_arg,		0,				0,				0,				0			},
	{ 121, "f4",			X_INV,	&invalid_arg,		0,				0,				0,				0			},
	{ 122, "f5",			X_INV,	&invalid_arg,		0,				0,				0,				0			},
	...
	{ 163, "autolang",		X_FIX,	&filename_coding,	FILENAME_CODING_AUTO,	0,		0,				0			},
	{ 163, "ascii",			X_FIX,	&filename_coding,	FILENAME_CODING_ASCII,	0,		0,				0			},
	{ 163, "euc",			X_FIX,	&filename_coding,	FILENAME_CODING_EUC,	0,		0,				0			},
	{ 163, "sjis",			X_FIX,	&filename_coding,	FILENAME_CODING_SJIS,	0,		0,				0			},
	{ 163, "utf8",			X_FIX,	&filename_coding,	FILENAME_CODING_UTF8,	0,		0,				0			},
	...
	{ 167, "classic",		X_FIX,	&menu_thema,		MENU_THEMA_CLASSIC,		0,		0,				OPT_SAVE	},
	{ 167, "light",			X_FIX,	&menu_thema,		MENU_THEMA_LIGHT,		0,		0,				OPT_SAVE	},
	{ 167, "dark",			X_FIX,	&menu_thema,		MENU_THEMA_DARK,		0,		0,				OPT_SAVE	},
	{ 168, "pausemsg",		X_FIX,	&pause_msg,			TRUE,			0,				0,				OPT_SAVE	},
	{ 168, "nopausemsg",	X_FIX,	&pause_msg,			FALSE,			0,				0,				OPT_SAVE	},
	...
	{ 252, "verbose",		X_INT,	&verbose_level,		0x00,			0xff,			o_verbose,		0			},
	...
	{ 265, "statistics",	X_FIX,	&show_statistics,	TRUE,			0,				0,				0			},
	{ 265, "nostatistics",	X_FIX,	&show_statistics,	FALSE,			0,				0,				0			},
	...
	{	0, "pcgvol",		X_INV,	&invalid_arg,		0,				0,				0,				0			},
	{	0, "gv",			X_INV,	&invalid_arg,		0,				0,				0,				0			},
						...
						const T_CONFIG_TABLE *sound_options)
{
	...
	if (opt1 == NULL) {
		fprintf(fp_stderr(), "error: internal error in check_option()\n");
		return -1;
	}
	if (opt1[0] != '-') {
		return 0;
		...
		/* int: *var = argv [範囲 var1..val2] */
	{
		...
		if (opt2) {
			...
			fprintf(fp_stderr(), "error: %s requires an argument\n", opt1);
		}
	}
	break;

	case X_DBL:
		/* double: *var = argv [範囲 var1..val2] */
	{
	...
	case X_INV:
		...
		if (op->var && opt2) {
			ret_val ++;
			fprintf(fp_stderr(), "error: invalid option %s %s\n", opt1, opt2);
		} else {
			fprintf(fp_stderr(), "error: invalid option %s\n", opt1);
		}
		break;
	...
	/*if (ret_val==1) fprintf(fp_stderr(),"done:%s\n",opt1);*/
	/*if (ret_val==2) fprintf(fp_stderr(),"done:%s %s\n",opt1,opt2);*/
	...
	for (i = 1; i < argc;) {
		...
		if (*argv[i] != '-') {
			...
			if (strlen(argv[i]) >= QUASI88_MAX_FILENAME) {
				...
				if (drive >= NR_DRIVE) {
					fprintf(fp_stderr(), "warning: too many image file\n");
				} else {
					fname = argv[i];

					p = (char *)malloc(strlen(fname) + 1);
					if (p == NULL) {
						fprintf(fp_stderr(), "error: malloc failed for arg\n");
						return FALSE;
					}
					strcpy(p, fname);
			...
			for (j = 0; i + j + 1 < argc; j++) {
				...
				if (fname) {
					...
					if (drive >= NR_DRIVE) {
						fprintf(fp_stderr(), "error: too many image-number\n");
					} else {
						p = (char *)malloc(strlen(fname) + 1);
						if (p == NULL) {
							fprintf(fp_stderr(),
									"error: malloc failed for arg\n");
							return FALSE;
						}
						strcpy(p, fname);
			...
			if (j == 0) {
				/* 未知のオプションは、スキップ */
				fprintf(fp_stderr(), "error: unknown option %s\n", argv[i]);
				j = 1;
			}
						   ...
						   const T_CONFIG_TABLE *sound_options)
{
	...
	while (osd_fgets(line, MAX_RCFILE_LINE, fp)) {
		...
		if (parm1 == NULL) {
			...
			/* パラメータ3個以上 */
			fprintf(fp_stderr(),
					"error: too many argument in line %d\n", line_cnt);
			...
			if ((result == 1 && parm2 == NULL) || (result == 2 && parm2)) {
				...
				/* エラー時は エラー行を表示 */
				fprintf(fp_stderr(), "error: invalid in line %d\n", line_cnt);
			}
		}
...
int config_init(int argc,
				char *argv[],
				const T_CONFIG_TABLE *osd_options,
				void (*osd_help)(FILE *fp),
				FILE *(*osd_output_file)(void))
{
	int  i, step;
	char *fname;
	...
	if (resume_flag == FALSE) {
		...
		for (i = 0; i < NR_DRIVE; i++) {
			...
			if (config_image.d[i]) {
				...
				if (fname == NULL) {
					fprintf(fp_stderr(), "\n");
					fprintf(fp_stderr(), "[[[ %-26s ]]]\n", "Open failed");
					fprintf(fp_stderr(), "[[[   drive %d: %-15s ]]]\n" "\n",
	...
	for (step = 0; step < 2; step ++) {
		...
		if (step == 0) {
			...
			if (config_image.d[DRIVE_1]) {
				fname = config_image.d[DRIVE_1];
			} else if (config_image.d[DRIVE_2]) {
				fname = config_image.d[DRIVE_2];
			} else if (config_image.t[CLOAD]) {
				fname = config_image.t[CLOAD];
			} else {
				break;
			}
						...
						const struct T_CONFIG_TABLE *op, char opt_arg[255])
{
	...
	case 0:
		table = table_func;
		nr_table = COUNTOF(table_func);
		break;
	case 1:
		table = table_cursor;
		nr_table = COUNTOF(table_cursor);
		break;
	case 2:
		table = table_mouse;
		nr_table = COUNTOF(table_mouse);
		break;
	case 3:
		table = table_joy;
...
static void config_write(const char *opt_name, const char *opt_arg)
{
	...
	if (opt_name) {
		sprintf(buf, "-%-.34s %-.34s", opt_name, (opt_arg ? opt_arg : ""));
	} else {
		if (opt_arg == NULL) {
			return;
		}
		sprintf(buf, "# -%-.67s", opt_arg);
	}
	sprintf(line, "%-70.70s %s\n", buf, AUTO_SAVE_COMMENT);
...
int config_save(const char *fname)
{
	...
	/* 設定ファイルを開く */
	fp = osd_fopen(FTYPE_CFG, fname, "rb");
	if (fp) {
		/* バックアップファイル名生成*/
		int flen = (int)strlen(fname);
		int slen = (int)strlen(CONFIG_SUFFIX);
	...
	if (backup_ok) {
		...
		while (osd_fgets(line, MAX_RCFILE_LINE, fp_bak)) {
			int flen = (int)strlen(line);
			int slen = (int)strlen(AUTO_SAVE_COMMENT);
			...
			if (saved_option[ op->group ] == FALSE) {
				...
				if (op->save_func != NULL) {
					...
					if ((func)(op, opt_arg)) {
						...
						sprintf(buf, "-%-.34s %-.34s", op->name, opt_arg);
						sprintf(line, "%-70.70s %s\n", buf, AUTO_SAVE_COMMENT);
						osd_fputs(line, fp);
					}
				}
